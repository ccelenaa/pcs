  ...
  return (<>
    <div className="tab-container">
      <div className="row header">
        ...
        <div className="cell slim70">Reservation</div>
        ...
        biens.filter(b=>(b.validated_at!==null && b.suspended_at==null && b.bailleur_suspended_at==null)).map((bien) => 
          <>
            <div className="row">
              ...
              <div className="cell slim70"><input type="button" value="Reserver" data-bienid={bien.id} onClick={reserver}/></div>
