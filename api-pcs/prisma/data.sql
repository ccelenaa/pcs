BEGIN;
INSERT INTO public.organizations (id,"type",reference,name,description,locale,"options","data",start_at,end_at,expired_at,suspended_at,closed_at,deleted_at,created_at,updated_at) VALUES
